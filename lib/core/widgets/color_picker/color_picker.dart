...
///Displays a color picker from an array of [Color]
///
///note: please don't repeat colors in the color list, this may cause UI inconsistences :D
    ...
    return  Center(
      child: Padding(
        ...
        child: GridView.count(
          ...
          mainAxisSpacing: 3,
          crossAxisSpacing: 3,
          children: colorsToTiles()
          )
      )
    );
  }

  List<_ColorTile> colorsToTiles(){
